...
fold_num = 10
data_file = '../PythonProject2/train_set.csv'
import pandas as pd
...
# test
test_data_file = '../PythonProject2/test_a.csv'
...
class Trainer():
    ...
    def test(self):
        self.model.load_state_dict(torch.load(save_model,weights_only=True))
        return self._eval(self.last_epoch + 1, test=True)
